...
*```mysql-memory-server``` gets tested on Ubuntu 22.04 (x64 and arm64), 24.04 (x64 and arm64), and 26.04 (x64 and arm64), Fedora 42 (x64 and arm64) 43 (x64 and arm64), and 44 (x64 and arm64), Alpine 3.20 - 3.24 (x64 and arm64), macOS 14 (arm64), 15 (x64 and arm64), and 26 (x64 and arm64), Windows 11 (arm64), and Windows Server 2022 (x64) and 2025 (x64). Linux distributions and Windows and macOS versions other than the ones tested may or may not work and are not guaranteed to work with this package.*
...
Linux, Windows, macOS x64: MySQL v5.7.19 - v26.7.0

Linux ARM64: MySQL v8.0.31 - v26.7.0

macOS ARM64: MySQL v8.0.26 - v26.7.0
...
| v8.0.40 - v8.0.45 OR v8.4.3 - v8.4.11 OR v9.1.0 - v26.7.0 | macOS 14 (Sonoma) |
...
*Document last updated in v1.16.0*