...
export declare const DOWNLOADABLE_MYSQL_VERSIONS: readonly ['5.7.19', '5.7.20', '5.7.21', '5.7.22', '5.7.23', '5.7.24', '5.7.25', '5.7.26', '5.7.27', '5.7.28', '5.7.29', '5.7.30', '5.7.31', '5.7.32', '5.7.33', '5.7.34', '5.7.35', '5.7.36', '5.7.37', '5.7.38', '5.7.39', '5.7.40', '5.7.41', '5.7.42', '5.7.43', '5.7.44', '8.0.0', '8.0.1', '8.0.2', '8.0.3', '8.0.4', '8.0.11', '8.0.12', '8.0.13', '8.0.14', '8.0.15', '8.0.16', '8.0.17', '8.0.18', '8.0.19', '8.0.20', '8.0.21', '8.0.22', '8.0.23', '8.0.24', '8.0.25', '8.0.26', '8.0.27', '8.0.28', '8.0.30', '8.0.31', '8.0.32', '8.0.33', '8.0.34', '8.0.35', '8.0.36', '8.0.37', '8.0.39', '8.0.40', '8.0.41', '8.0.42', '8.0.43', '8.0.44', '8.0.45', '8.1.0', '8.2.0', '8.3.0', '8.4.0', '8.4.2', '8.4.3', '8.4.4', '8.4.5', '8.4.6', '8.4.7', '8.4.8', '8.4.9', '8.4.10', '8.4.11', '9.0.1', '9.1.0', '9.2.0', '9.3.0', '9.4.0', '9.5.0', '9.6.0', '9.7.0', '9.7.1', '9.7.2', '26.7.0'];
export declare const MYSQL_ARCH_SUPPORT: {
    readonly darwin: {
        readonly arm64: '8.0.26 - 26.7.0';
        readonly x64: '5.7.19 - 26.7.0';
    };
    readonly linux: {
        readonly arm64: '8.0.31 - 26.7.0';
        readonly x64: '5.7.19 - 26.7.0';
    };
    readonly win32: {
        readonly x64: '5.7.19 - 26.7.0';
        readonly arm64: '0.0.0';
    };
};
export declare const MYSQL_MIN_OS_SUPPORT: {
    ...
    readonly darwin: {
        ...
        readonly '8.0.40 - 8.0.45 || 8.4.3 - 8.4.11 || 9.1.0 - 9.7.2 || 26.7.0': '23.0.0';
    };
};
...
export declare const MYSQL_LINUX_FILE_EXTENSIONS: {
    readonly x64: {
        ...
        readonly '8.0.12 - 26.7.0': 'xz';
    };
    readonly arm64: {
        readonly '8.0.31 - 8.0.32': 'gz';
        readonly '8.0.33 - 26.7.0': 'xz';
    };
};
export declare const MYSQL_LINUX_MINIMAL_REBUILD_VERSIONS = "8.0.26";
export declare const MYSQL_ALPINE_VERSION_RANGE = "8.4.0 - 8.4.11 || 9.0.1 - 9.6.0";
export {};
