...
export declare const MYSQL_MIN_OS_SUPPORT: {
    ...
    readonly darwin: {
        ...
        readonly '8.0.40 - 8.0.45 || 8.4.3 - 8.4.8 || 9.1.0 - 9.6.0': "23.0.0";
    };
};
...
export declare const MYSQL_MACOS_VERSIONS_IN_FILENAME: {
    ...
    readonly '8.0.41 - 8.0.45 || 8.4.4 - 8.4.8 || 9.2.0 - 9.6.0': "macos15";
};
...
export declare const MYSQL_LINUX_FILE_EXTENSIONS: {
    readonly x64: {
        ...
        readonly '8.0.12 - 9.6.0': "xz";
    };
    readonly arm64: {
        readonly '8.0.31 - 8.0.32': "gz";
        readonly '8.0.33 - 9.6.0': "xz";
    };
};
