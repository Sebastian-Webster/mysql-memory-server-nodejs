...
- If the system does not have MySQL installed, the latest version of MySQL that [this package supports downloading](https://github.com/Sebastian-Webster/mysql-memory-server-nodejs/blob/v1.16.0/docs/SUPPORTED_MYSQL_DOWNLOADS.md) will be downloaded.
